      ...
      <div className="naxatw-container naxatw-h-full !naxatw-max-w-full naxatw-py-12">
        ...
        <FlexColumn
          className="
            ...
            naxatw-items-center naxatw-justify-center naxatw-pb-20
            naxatw-text-center
        ...
        >
          ...
          >
            ...
            <p className="naxatw-mt-4 naxatw-animate-fade-up naxatw-text-[1.5rem] naxatw-leading-8 md:naxatw-mt-8 md:naxatw-text-2xl">
