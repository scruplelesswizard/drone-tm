        ...
        return (
          ...
          >
            <input
              ...
              name={option.name}
              value={option.value}
              className={`naxatw-h-4 naxatw-min-h-4 naxatw-w-4 naxatw-min-w-4 naxatw-cursor-pointer naxatw-appearance-none naxatw-rounded-full naxatw-border-2 naxatw-border-[#555] naxatw-bg-white naxatw-transition-colors checked:naxatw-border-red checked:naxatw-shadow-[inset_0_0_0_3px_#D73F3F] focus-visible:naxatw-outline focus-visible:naxatw-outline-2 focus-visible:naxatw-outline-offset-2 focus-visible:naxatw-outline-red ${
                option?.disabled === true ? 'naxatw-cursor-not-allowed' : ''
              }`}
              onChange={e => {
