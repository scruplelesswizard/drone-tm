...
const sectionHeadingClass =
  'naxatw-mb-3 naxatw-text-body-btn naxatw-text-black';
...
const KeyParameters = ({ formProps }: { formProps: UseFormPropsType }) => {
  ...
  const isTerrainOutput =
    useCase.includes('DIGITAL_SURFACE_MODEL') ||
    useCase.includes('DIGITAL_TERRAIN_MODEL');
      ...
      {keyParamOption === 'basic' ? (
        <div className="naxatw-space-y-8">
          <section>
            <p className={sectionHeadingClass}>
              {m.create_params_section_resolution()}
            </p>
              ...
              {measurementType === 'gsd' ? (
                <FormControl className="naxatw-gap-1">
                  ...
                  {errors?.gsd_cm_px?.message && (
                    <ErrorMessage
                      message={errors?.gsd_cm_px?.message as string}
                    />
                  )}
                  <p className={helperTextClass}>
                    {m.create_params_gsd_recommended()}
                  </p>
                </FormControl>
              ) : (
                <FormControl className="naxatw-gap-1">
          ...
          <section>
            <p className={sectionHeadingClass}>
              {m.create_params_section_overlap()}
            </p>
            <div className="naxatw-space-y-4">
              <FormControl>
              ...
              {imageMergeType === 'overlap' ? (
                <>
                  <FlexRow className="naxatw-grid naxatw-grid-cols-2 naxatw-gap-3">
                    <FormControl className="naxatw-gap-1">
                      <Label required>
                        {m.create_params_front_overlap_label()}
                      </Label>
                      <Input
                      ...
                      {frontOverlapInputValue && agl ? (
                        <InfoMessage
                          message={m.create_params_front_overlap_equivalent_spacing(
                            {
                              spacing: getForwardSpacing(
                                agl,
                                frontOverlapInputValue,
                              )?.replace(/\.00$/, ''),
                            },
                          )}
                        />
                      ...
                      <ErrorMessage
                        message={
                          errors?.forward_overlap_percent?.message as string
                        }
                      />
                      <p className={helperTextClass}>
                    ...
                    <FormControl className="naxatw-gap-1">
                      <Label required>
                        {m.create_params_side_overlap_label()}
                      </Label>
                      <Input
                        placeholder={m.create_params_front_overlap_placeholder()}
                        type="number"
                      ...
                      {sideOverlapInputValue && agl ? (
                        <InfoMessage
                          message={m.create_params_side_overlap_equivalent_spacing(
                            {
                              spacing: getSideSpacing(
                                agl,
                                sideOverlapInputValue,
                              )?.replace(/\.00$/, ''),
                            },
                          )}
                        />
                      ...
                      <ErrorMessage
                        message={
                          errors?.side_overlap_percent?.message as string
                        }
                      />
                      <p className={helperTextClass}>
                        {m.create_params_recommended({
                  ...
                  <div className={infoCalloutClass}>
                    ...
                    <ul className="naxatw-ml-4 naxatw-list-disc naxatw-space-y-1 naxatw-text-body-sm naxatw-text-[#4A5568]">
                      {isTerrainOutput ? (
                        <li>
                          {renderStrongMessage(
                            m.create_params_overlap_guidance_terrain(),
                          )}
                        </li>
                      ) : (
                ...
                <FlexRow className="naxatw-grid naxatw-grid-cols-2 naxatw-gap-3">
                  <FormControl className="naxatw-gap-1">
                    <Label required>
                      {m.create_params_forward_spacing_label()}
                    </Label>
                    <Input
                    ...
                    {forwardSpacingInputValue && agl ? (
                      <InfoMessage
                        message={m.create_params_forward_spacing_equivalent_overlap(
                          {
                            overlap: getFrontOverlap(
                              agl,
                              forwardSpacingInputValue,
                            )?.replace(/\.00$/, ''),
                          },
                        )}
                      />
                  ...
                  <FormControl className="naxatw-gap-1">
                    <Label required>
                      {m.create_params_side_spacing_label()}
                    </Label>
                    <Input
                      placeholder={m.create_params_forward_spacing_placeholder()}
                      type="number"
                    ...
                    {sideSpacingInputValue && agl ? (
                      <InfoMessage
                        message={m.create_params_side_spacing_equivalent_overlap(
                          {
                            overlap: getSideOverlap(
                              agl,
                              sideSpacingInputValue,
                            )?.replace(/\.00$/, ''),
                          },
                        )}
                      />
              ...
              <div className="naxatw-rounded-md naxatw-border naxatw-border-[#E0E0E0] naxatw-bg-white naxatw-p-4">
                <FlexRow className="naxatw-items-center naxatw-justify-between naxatw-gap-3">
                  <p className="naxatw-text-body-btn">
                    {m.create_params_follow_terrain()}
                  </p>
                  <Switch
        ...
        <>
          <FormControl className="naxatw-mt-4 naxatw-gap-1">
            ...
            <Input
              placeholder={m.create_params_advanced_altitude_placeholder()}
            />
          </FormControl>
          <FormControl className="naxatw-mt-4 naxatw-gap-1">
            <Label>{m.create_params_advanced_gimbal_label()}</Label>
            <Input
              placeholder={m.create_params_advanced_gimbal_placeholder()}
            />
          </FormControl>
          <FormControl className="naxatw-mt-4 naxatw-gap-1">
            <Label>{m.create_params_advanced_distance_label()}</Label>
            <Input
              placeholder={m.create_params_advanced_distance_placeholder()}
            />
          </FormControl>
          <FormControl className="naxatw-mt-4 naxatw-gap-1">
            <Label>{m.create_params_advanced_overlap_label()}</Label>
            <Input
              placeholder={m.create_params_advanced_overlap_placeholder()}
            />
          </FormControl>
          <FormControl className="naxatw-mt-4 naxatw-gap-1">
            <Label>{m.create_params_advanced_line_orientation_label()}</Label>
            <Input
              placeholder={m.create_params_advanced_line_orientation_placeholder()}
            />
          </FormControl>
        </>
      )}
