...
import {
  generateQFieldProject,
  getQFieldProjectStatus,
} from '@Services/qfield';
...
function QFieldExportDialog({
  show,
  onClose,
  projectId,
}: QFieldExportDialogProps) {
  const [status, setStatus] = useState<
    'idle' | 'checking' | 'generating' | 'ready'
  >('idle');
        ...
        {status === 'ready' && qrSvg && (
          <div className="naxatw-flex naxatw-flex-col naxatw-items-center naxatw-gap-4">
            ...
            <div
              ...
              // eslint-disable-next-line react/no-danger -- qrSvg is locally generated by the qrcode library, not user input
